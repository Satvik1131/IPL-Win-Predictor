...
cities=[     'Bangalore',         'Mumbai',         'Indore',        'Kolkata',
...
with col1:
 batting_team=st.selectbox('Selct the batting team',sorted(teams))
with col2:
 bowling_team=st.selectbox('Selct the bowling team',sorted(teams))
